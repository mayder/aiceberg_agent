...
if grep -q '^AUTO_UPDATE_TRUST_REQUIRED=' "$ENV_DST"; then
  sed -i 's/^AUTO_UPDATE_TRUST_REQUIRED=.*/AUTO_UPDATE_TRUST_REQUIRED=true/' "$ENV_DST"
else
  printf '\nAUTO_UPDATE_TRUST_REQUIRED=true\n' >>"$ENV_DST"
fi
if grep -q '^AUTO_UPDATE_TRUST_PUBLIC_KEY=' "$ENV_DST"; then
  sed -i 's/^AUTO_UPDATE_TRUST_PUBLIC_KEY=.*/AUTO_UPDATE_TRUST_PUBLIC_KEY=9a74529340757946a091dff57d1d1fa721d4b129d76748b6e1c4533514c54045/' "$ENV_DST"
else
  printf 'AUTO_UPDATE_TRUST_PUBLIC_KEY=9a74529340757946a091dff57d1d1fa721d4b129d76748b6e1c4533514c54045\n' >>"$ENV_DST"
fi
