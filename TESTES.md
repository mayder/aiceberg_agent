...
- Validacao real parcial em `VMAIPROD2`/Oracle Linux em 2026-06-19: agente 0.8.8 ativo com canal direct, ping online, flush ACK e snapshots para agente 4; ainda pendem `smoke.sh` remoto, rollback real e demais ambientes/cenarios do gate.
