...
- Gate de fechamento: `scripts/pkg69_operational_evidence_gate.sh` gera/valida manifest TSV de evidencias reais; `scripts/pkg69_operational_evidence_gate_selftest.sh` roda em `./check.sh`.
