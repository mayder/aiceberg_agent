...
| Ubuntu/Debian | `smoke.sh`, systemd, logs, outbox, update | parcial real: Debian 11 id `1`, id `18` e id `19` atualizados com systemd ativo e envio ao AIceberg; Ubuntu 24.04 id `70` instalado em modo usuario/crontab e envio ao AIceberg; systemd/root, update/rollback e CPU dentro do limite ainda pendentes |
