...
| --- | --- | --- |
| API indisponivel | backoff, outbox preservada, sem crash | pendente |
| Rede intermitente | retry/backoff e flush posterior | pendente |
| Proxy/TLS | proxy autenticado e TLS invalido controlado | pendente |
| Disco cheio/outbox cheia | erro claro, sem corrupcao | pendente |
| Payload grande | limite/queda controlada em DogStatsD, OTLP e logs | pendente |
