...
- Decisao: manter uma chave privada Ed25519 oficial fora do Git, integrar assinatura obrigatória ao build de release, publicar manifesto verificável e provisionar somente a chave pública nos instaladores. Desde `0.8.48`, a chave pública e a exigência de assinatura são também defaults compilados para cobrir instalações legadas sem arquivo de ambiente. O backend aceita para update remoto apenas artefato com manifesto, SHA256 e assinatura válidos.
